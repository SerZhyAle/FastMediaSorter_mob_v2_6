...
class OneDriveFolderAdapter(
...
) : ListAdapter<CloudFolderItem, OneDriveFolderAdapter.FolderViewHolder>(FolderDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FolderViewHolder {
        val binding = ItemOnedriveFolderBinding.inflate(
    ...
    class FolderViewHolder(
        private val binding: ItemOnedriveFolderBinding,
        private val onFolderSelect: (CloudFolderItem) -> Unit,
        private val onFolderNavigate: (CloudFolderItem) -> Unit,
        private val onNavigateBack: () -> Unit,
        private val isRootLevel: () -> Boolean
